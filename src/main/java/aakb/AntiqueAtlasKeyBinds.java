...
import aakb.handlers.ModRegistry;
import aakb.proxy.CommonProxy;
...
public class AntiqueAtlasKeyBinds {
    public static final String MODID = "aakb";
    public static final String VERSION = "0.0.0";
    public static final String NAME = "AntiqueAtlasKeyBinds";
    public static final Logger LOGGER = LogManager.getLogger();
    public static boolean completedLoading = false;
	
    @SidedProxy(clientSide = "aakb.proxy.ClientProxy", serverSide = "aakb.proxy.CommonProxy")
