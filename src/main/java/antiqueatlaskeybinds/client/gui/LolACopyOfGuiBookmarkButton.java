package antiqueatlaskeybinds.client.gui;
 ...
 * bulge on mouseover. */
public class LolACopyOfGuiBookmarkButton extends GuiToggleButton {
	 ...
	 */
	public LolACopyOfGuiBookmarkButton(int colorIndex, ResourceLocation iconTexture, String title) {
